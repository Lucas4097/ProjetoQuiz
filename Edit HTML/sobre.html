...
<body class="font-sigmar bg-fundosite">
    ...
    <footer>
      ...
      caption {font-size: x-large;}
          ...
          <tbody>
          <tr>
          <td class="text-center my-3 text-light" rowspan="2">Acesse as redes sociais dos alunos e saiba mais</td>
          ...
          <tfoot>
              <tr><td  class="text-center my-3 text-light" colspan="4">© 2019-2022 Puzzle Brain Co., Inc. Todos os direitos 
                  reservados.</td></tr>
      </tfoot> 
      </table>
