  ...
  <div id="corpo_game" class="container mt-2">
    <form action="game.php" method="POST">
      ...
      <div id="animacaoCE" class="text-light card border-0 bg-transparent">
        ...
        <div class="btn-group my-3 d-flex align-content-center justify-content-center flex-wrap row g-1" data-toggle="buttons">
          <div class="col-12 col-sm-12 col-md-6 unidade-grupo">
            <label class="w-100 h-100 btn btn-primary bg-azulclaro borda-azul btn btn-outline-light btn-lg">
